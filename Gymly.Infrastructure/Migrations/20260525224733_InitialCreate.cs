        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceCardToken = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PlanAccessRules",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlanId = table.Column<int>(type: "int", nullable: false),
                    RuleType = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanAccessRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanAccessRules_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemUsers_SystemRoles_SystemRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_AttendanceCardToken",
                table: "Members",
                column: "AttendanceCardToken",
                unique: true,
                filter: "[AttendanceCardToken] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanAccessRules_PlanId",
                table: "PlanAccessRules",
                column: "PlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemUsers_SystemRoleId",
                table: "SystemUsers",
                column: "SystemRoleId");
